...
export default class Live extends Component {
  ...
  setLocation = () => {
    Location.watchPositionAsync(
      ...
      ({ coords }) => {
        const newDirections = calculateDirection(coords.heading);
        const { direction, bounceValue } = this.state;

        if (newDirections !== direction) {
          Animated.sequence([
    ...
    if (status === "denied") {
      return (
        <View style={styles.center}>
          ...
          <Text>
            You denied your location. You can fix this by visiting your setting
    ...
    if (status === "undetermined") {
      return (
        <View style={styles.center}>
          ...
          <TouchableOpacity onPress={this.askPermisson} style={styles.button}>
